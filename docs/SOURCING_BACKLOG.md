...
*The figures in this section are P9's, kept as the record of what that phase
measured. They are not current: the corpus, the packs and the rulepack have all
moved since. The current figures are in `eval/reports/evaluation.txt`, which is
regenerated by `make evaluate` — as of ADR 0053, Cisco precision 100% over 20
assertions, recall 76.9%, FAIL recall 77.8% (7 of 9), wrong-confident 0.*
